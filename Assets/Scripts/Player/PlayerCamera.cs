...
public class PlayerCamera : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        transform.position = Vector3.SmoothDamp(transform.position, target, ref currentVelocity, smoothTime * Time.deltaTime);
        ...
        if (transform.position.y < player.position.y + 1.5f)
        {
            ...
            pos.y = Mathf.Lerp(transform.position.y, player.position.y + 1.5f, Time.deltaTime * speed);
